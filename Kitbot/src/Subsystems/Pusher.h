...
public:
	...
	bool GetLimitSwitchOut(){return (m_cPushMotor->IsRevLimitSwitchClosed() == 1); !m_cSwitchOut->Get();};
	bool GetLimitSwitchIn(){return (m_cPushMotor->IsFwdLimitSwitchClosed() == 1); !m_cSwitchIn->Get();};
