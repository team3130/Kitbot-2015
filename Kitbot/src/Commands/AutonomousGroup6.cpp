...
AutonomousGroup6::AutonomousGroup6()
{
	...
	AddParallel(m_cAutonLifter1);			//lifts bin up
...
void AutonomousGroup6::Initialize()
{
	...
	m_cAutonLifter1->SetGoal(
			...
			Preferences::GetInstance()->GetDouble("Auton6-Lifter1-Goal",2000));
	m_cAutonLifter2->SetGoal(
			...
			Preferences::GetInstance()->GetDouble("Auton6-Lifter2-Goal",1800));
	m_cAutonLifter3->SetGoal(
			...
			Preferences::GetInstance()->GetDouble("Auton6-Lifter3-Goal",2000));

		//Driving
	m_cAutonDriveStraight1->SetGoal(
			Preferences::GetInstance()->GetDouble("Auton6-Distance-Tote",20),
