...
void AutonomousGroup2::Initialize()
{
	...
	m_cAutonDrive1->SetGoal(
			...
			Preferences::GetInstance()->GetDouble("Auto-Speed-Step",0.50),
	...
	m_cAutonDumb1->SetGoal(
			Preferences::GetInstance()->GetDouble("Auto-Dumb-Speed", 0.50),
			Preferences::GetInstance()->GetDouble("Auto-Dumb-Time", 1));
